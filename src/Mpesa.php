...
// to read the .env file make sure you have installed dotenv library
...
class Mpesa
{
    ...
    public static function env($env_param)
    {
        ...
        //uncomment this code if you have a dotenv library for reading .env file
        /*
        $dotenv = new dotenv('MPESA_CONSUMER_KEY');
        ...
        */
        ...
        //this code is for, incase you dont have dotenv library
        //if you have the library you can comment it
         ...
         * MPESA_CONSUMER_SECRET = loSo7OkjI7AKoys3
